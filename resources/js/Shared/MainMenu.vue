  ...
  <div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/">
        ...
        <div :class="isUrl('') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">{{__('menu.dashboard')}}</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/organizations">
        ...
        <div :class="isUrl('organizations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">{{__('menu.organizations')}}</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/contacts">
        ...
        <div :class="isUrl('contacts') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">{{__('menu.contacts')}}</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/reports">
        ...
        <div :class="isUrl('reports') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">{{__('menu.reports')}}</div>
      </Link>
    </div>
  </div>
</template>
